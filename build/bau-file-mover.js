...
var BauFileMover = (function () {
    function BauFileMover(project, dependencyGraph) {
        ...
        this.importService = new bau_import_service_1.BauImportService();
    }
    /**
     * Throws error if
     ...
     */
    BauFileMover.prototype.move = function (fileName, targetFileName) {
        var _this = this;
        /**
...
exports.BauFileMover = BauFileMover;
